...
func TestStorage(t *testing.T) {
	...
	file.Create("test.txt", []byte("Yafgo"))
	initConfig()
	...
	disks := []TestDisk{
		...
		{
			disk: "oss",
			url:  "https://yafgo.oss-cn-beijing.aliyuncs.com/",
		},
		{
			disk: "cos",
			url:  "https://yafgo-1257814968.cos.ap-beijing.myqcloud.com/",
		},
		{
			disk: "s3",
			url:  "https://yafgo.s3.us-east-2.amazonaws.com/",
		},
		{
			disk: "custom",
			url:  "http://localhost/storage/",
	...
	tests := []struct {
	...
	}{
		{
			name: "Put",
			setup: func(name string, disk TestDisk) {
				assert.Nil(t, driver.Put("Put/1.txt", "Yafgo"), name)
		...
		},
		{
			name: "Url",
			setup: func(name string, disk TestDisk) {
				assert.Nil(t, driver.Put("Url/1.txt", "Yafgo"), name)
				...
				if disk.disk != "local" && disk.disk != "custom" {
					...
					resp.Body.Close()
					assert.Nil(t, err, name)
					assert.Equal(t, "Yafgo", string(content), name)
				}
			},
		},
		{
			name: "TemporaryUrl",
			setup: func(name string, disk TestDisk) {
				assert.Nil(t, driver.Put("TemporaryUrl/1.txt", "Yafgo"), name)
		...
		},
		{
			name: "Copy",
			setup: func(name string, disk TestDisk) {
				assert.Nil(t, driver.Put("Copy/1.txt", "Yafgo"), name)
		...
		},
		{
			name: "Move",
			setup: func(name string, disk TestDisk) {
				assert.Nil(t, driver.Put("Move/1.txt", "Yafgo"), name)
		...
		},
		{
			name: "Delete",
			setup: func(name string, disk TestDisk) {
				assert.Nil(t, driver.Put("Delete/1.txt", "Yafgo"), name)
		...
		},
		{
			...
			setup: func(name string, disk TestDisk) {
				assert.Nil(t, driver.Put("DeleteDirectory/1.txt", "Yafgo"), name)
		...
		},
		{
			name: "Files",
			setup: func(name string, disk TestDisk) {
				assert.Nil(t, driver.Put("Files/1.txt", "Yafgo"), name)
				assert.Nil(t, driver.Put("Files/2.txt", "Yafgo"), name)
				assert.Nil(t, driver.Put("Files/3/3.txt", "Yafgo"), name)
				assert.Nil(t, driver.Put("Files/3/4/4.txt", "Yafgo"), name)
		...
		},
		{
			name: "AllFiles",
			setup: func(name string, disk TestDisk) {
				assert.Nil(t, driver.Put("AllFiles/1.txt", "Yafgo"), name)
				assert.Nil(t, driver.Put("AllFiles/2.txt", "Yafgo"), name)
				assert.Nil(t, driver.Put("AllFiles/3/3.txt", "Yafgo"), name)
				assert.Nil(t, driver.Put("AllFiles/3/4/4.txt", "Yafgo"), name)
		...
		},
		{
			name: "Directories",
			setup: func(name string, disk TestDisk) {
				assert.Nil(t, driver.Put("Directories/1.txt", "Yafgo"), name)
				assert.Nil(t, driver.Put("Directories/2.txt", "Yafgo"), name)
				assert.Nil(t, driver.Put("Directories/3/3.txt", "Yafgo"), name)
				assert.Nil(t, driver.Put("Directories/3/5/5.txt", "Yafgo"), name)
		...
		},
		{
			name: "AllDirectories",
			setup: func(name string, disk TestDisk) {
				assert.Nil(t, driver.Put("AllDirectories/1.txt", "Yafgo"), name)
				assert.Nil(t, driver.Put("AllDirectories/2.txt", "Yafgo"), name)
				assert.Nil(t, driver.Put("AllDirectories/3/3.txt", "Yafgo"), name)
				assert.Nil(t, driver.Put("AllDirectories/3/5/6/6.txt", "Yafgo"), name)
